"""tudor_and_twinkle_17377 URL Configuration
...
admin.site.site_header = "Tudor and Twinkle"
admin.site.site_title = "Tudor and Twinkle Admin Portal"
admin.site.index_title = "Tudor and Twinkle Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Tudor and Twinkle API",
        default_version="v1",
        description="API documentation for Tudor and Twinkle App",
    ),
    public=True,
